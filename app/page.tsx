...
import {beginLocalAccount} from "@/app/utils/account";

export default function Home(){
  const [entryOpen,setEntryOpen]=useState(false),router=useRouter();
  const closeEntry=useCallback(()=>setEntryOpen(false),[]);
  const exploreDemo=()=>{beginLocalAccount("demo");router.push("/launches")};
