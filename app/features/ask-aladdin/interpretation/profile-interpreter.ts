...
export function interpretDataset(mode:AnswerMode,plan:QueryPlan,dataset:ResultDataset){
 ...
 if(mode==="Analyst")return plan.kind==="wallets"?"Five of six classified specialists remain in the cohort. The table is ranked by remaining BARK quantity; classification coverage is synthetic and limited to the observed fixture.":"Lifecycle retention and liquidity deterioration explain most of the difference in this synthetic cohort; the sample is descriptive, not causal.";
